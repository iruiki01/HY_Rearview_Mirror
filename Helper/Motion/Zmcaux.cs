...
/*        [DllImport("zauxdll.dll", EntryPoint = "ZAux_Scope", CharSet = CharSet.Ansi, CallingConvention = CallingConvention.StdCall)]
        ...
        public static extern Int32 ZAux_BusCmd_SDORead2(IntPtr handle, UInt32 slot, UInt32 node, UInt32 index, UInt32 subindex, UInt32 type, StringBuilder Out_string);
