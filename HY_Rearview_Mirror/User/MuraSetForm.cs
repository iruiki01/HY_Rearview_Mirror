...
namespace HY_Rearview_Mirror.User
{
    ...
    /// Mura检测
    /// </summary>
    public partial class MuraSetForm : UIForm
    {
        /// <summary>
        /// 等待图标志
        /// </summary>
        ...
        private void uiButton4_Click(object sender, EventArgs e)
        {
            ...
            eventManager.Trigger("发送界面参数", new List<object>() { str0, value0, value1, str1, str3 });

            UIMessageBox.ShowSuccess("参数已设置成功！");
        }
        public void SetDataToForm(ITestParam testParam, string VersionStr = "")
        {
            MuraFunTestParam muraFunTestParam = testParam as MuraFunTestParam;
